...
class _SettingsScreenState extends State<SettingsScreen> {
            ...
            body: CustomScrollView(slivers: [
              SliverAppBar(
                ...
                title: Row(
                  ...
                  children: [
                    Text(AppLocalizations.of(ctx).settingsTitle,
                        style: TextStyle(
                            fontSize: 22,
                    ...
                    children: [
                      ...
                      _Group(ctx: ctx, children: [
                        ...
                        _Toggle(
                          ...
                          onChanged: (v) {
                            notifications.setEnabled(v);
                            _snack(
                                ctx,
                                v
                                    ? AppLocalizations.of(ctx).settingsNotifOn
                                    : AppLocalizations.of(ctx)
                                        .settingsNotifOff);
                          },
                        ),
                      ...
                      _Group(ctx: ctx, children: [
                        ...
                        _Nav(
                          ...
                          value: notifications.aqiThreshold.toString(),
                          onTap: () => _pick(
                            ctx,
                            title:
                                AppLocalizations.of(ctx).settingsAqiThreshold,
                            options: const [
                              '50 — Good',
                              '100 — Moderate',
                              '150 — Sensitive',
                            ...
                            current: notifications.thresholdLabel,
                            onSelect: (v) {
                              final threshold =
                                  int.tryParse(v.split(' ').first) ?? 150;
                              notifications.setAqiThreshold(threshold);
                              _snack(
                                  ctx,
                                  AppLocalizations.of(ctx)
                                      .settingsThresholdSelected(v));
                            },
                          ),
                        ),
                        _Nav(
                      ...
                      Center(
                          child: Text(AppLocalizations.of(ctx).settingsFooter,
                              style: TextStyle(
                                  fontSize: 12, color: _textSub(ctx)))),
      ...
      builder: (_) => SafeArea(
        ...
        children: [
          Container(
              ...
              height: 4,
              decoration: BoxDecoration(
                  color: _border(c), borderRadius: BorderRadius.circular(2))),
          Padding(
  ...
  void _aboutDialog(BuildContext c) {
    ...
    showDialog(
        ...
        builder: (_) => AlertDialog(
              ...
              title: Text('AirWatch',
                  style: TextStyle(
                      color: _textMain(c), fontWeight: FontWeight.w700)),
              content: Text(l10n.settingsAboutContent,
                  style:
                      TextStyle(color: _textSub(c), fontSize: 13, height: 1.5)),
              actions: [
                TextButton(
                    onPressed: () => Navigator.pop(c),
  ...
  void _openLogin(BuildContext c) => Navigator.of(c)
      .push(MaterialPageRoute(builder: (_) => const LoginScreen()));

  void _openRegister(BuildContext c) => Navigator.of(c)
...
class _GuestCard extends StatelessWidget {
  ...
  const _GuestCard(
      {required this.ctx, required this.auth, required this.onTap});
        ...
        child: Row(children: [
          Container(
              ...
              child: Icon(CupertinoIcons.person_fill,
                  size: 26, color: loggedIn ? Colors.white : _textSub(ctx))),
          ...
          if (!loggedIn)
            Container(
              ...
              decoration: BoxDecoration(
                  color: _accent, borderRadius: BorderRadius.circular(99)),
          ...
          child: Row(children: [
            Expanded(
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                  Text(AppLocalizations.of(ctx).settingsCreateAccount,
                      style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w700,
                          color: Colors.white)),
            ...
            Container(
              ...
              child: Text(AppLocalizations.of(ctx).settingsGetStarted,
                  style: TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.w700,
                      color: _accent)),
