...
// ─── Simple App Settings State (InheritedWidget — no extra packages) ──────────

class AppSettings extends InheritedWidget {
  final AppSettingsState data;
  const AppSettings({super.key, required this.data, required super.child});

  static AppSettingsState of(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<AppSettings>()!.data;

  @override
  bool updateShouldNotify(AppSettings old) => true;
}
...
class _SettingsScreenState extends State<SettingsScreen> {
  // Local reactive copy — rebuilt when user changes something
                    ...
                    children: [
                      ...
                      _Group(children: [
                        _ToggleRow(
                          ...
                          onChanged: (v) {
                            ...
                            // TODO: pass v to your ThemeMode controller
                      ...
                      _Group(children: [
                        _NavRow(
                          ...
                          onTap: () => _pick(
                            title: 'Language',
                            options: ['English', 'Kiswahili', 'French',
                                      'Arabic', 'Portuguese'],
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          ...options.map((o) {
            ...
            return ListTile(
              onTap: () {
                onSelect(o);
                setState(() {});   // rebuild screen with new value
  ...
  void _storageDialog() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        backgroundColor: _cardBg,
        title: const Text('Storage', style: TextStyle(color: _textMain)),
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          _storageBar('Cache', 1.2, 4.0, const Color(0xFF007AFF)),
          const SizedBox(height: 12),
          _storageBar('Data', 0.8, 4.0, const Color(0xFF34C759)),
          const SizedBox(height: 12),
          _storageBar('Logs', 0.4, 4.0, const Color(0xFFFF9500)),
        ]),
        actions: [
          TextButton(
            onPressed: () { Navigator.pop(context); _toast('Cache cleared'); },
            child: const Text('Clear Cache', style: TextStyle(color: _accent)),
          ),
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('Done', style: TextStyle(color: _textSub)),
          ),
        ],
      ),
    );
  ...
  Widget _storageBar(String label, double used, double total, Color color) {
        ...
        content: const Column(mainAxisSize: MainAxisSize.min,
          ...
          children: [
            ...
            Text('Version 1.0.0',
                style: TextStyle(color: _textSub, fontSize: 13)),
            SizedBox(height: 12),
            Text('Monitoring Dar es Salaam\'s air '
                'quality in real time using IoT sensors '
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(label, style: const TextStyle(fontSize: 15, color: _textMain)),
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(children: [
          ...
          if (value != null)
            Text(value!, style: const TextStyle(fontSize: 13, color: _textSub)),
